...
public enum MigrationReasonCode: String, Sendable, Codable, CaseIterable {
    ...
    case registrySourceEvidenceMissing = "registry_source_evidence_missing"
    case registrySourceUnsupported = "registry_source_unsupported"
    case registrySourceEvidenceConflict = "registry_source_evidence_conflict"
    ...
    case externalGitSourceAnalyzed = "external_git_source_analyzed"
    case externalGitMutableReference = "external_git_mutable_ref"
    case externalGitUnpinned = "external_git_unpinned"
    case externalGitEvidenceIncomplete = "external_git_evidence_incomplete"
    case externalGitEvidenceConflict = "external_git_evidence_conflict"
    case externalGitRepositoryAmbiguous = "external_git_repository_ambiguous"
    case externalGitURLUnsupported = "external_git_url_unsupported"
    case externalGitSyntaxUnsupported = "external_git_syntax_unsupported"
    case externalGitCredentialsRedacted = "external_git_credentials_redacted"
