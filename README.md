...
and the [0.7.1 release notes](Documentation/ReleaseNotes-0.7.1.md).
...
| Podspec JSON declarations | Released v0.5.0/v0.6.0 APIs inspect caller-supplied in-memory declarations and one synthetic S1 blueprint shape. This checkout's unreleased local-report command is separate, observes only explicitly selected bytes, and cannot authorize migration |
